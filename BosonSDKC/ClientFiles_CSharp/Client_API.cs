...
namespace Boson {
	...
	// Begin Module agc
		...
		public FLR_RESULT agcSetDetailHeadroomBalance(Double data){
			FLR_RESULT returncode = ClientPackager.AgcSetDetailHeadroomBalance(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcGetDetailHeadroomBalance(out Double data){
			FLR_RESULT returncode = ClientPackager.AgcGetDetailHeadroomBalance(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcGetDetailHeadroomApplied(out Double countsHigh, out Double countsLow){
			FLR_RESULT returncode = ClientPackager.AgcGetDetailHeadroomApplied(this, out countsHigh, out countsLow);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcSetRadius(UInt32 data){
			FLR_RESULT returncode = ClientPackager.AgcSetRadius(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcGetRadius(out UInt32 data){
			FLR_RESULT returncode = ClientPackager.AgcGetRadius(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcSetGmax(Double data){
			FLR_RESULT returncode = ClientPackager.AgcSetGmax(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcGetGmax(out Double data){
			FLR_RESULT returncode = ClientPackager.AgcGetGmax(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcSetGmin(Double data){
			FLR_RESULT returncode = ClientPackager.AgcSetGmin(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT agcGetGmin(out Double data){
			FLR_RESULT returncode = ClientPackager.AgcGetGmin(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module boson
		...
		public FLR_RESULT bosonGetBoardID(out UInt32 data){
			FLR_RESULT returncode = ClientPackager.BosonGetBoardID(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonSetAutoGainSwitchConditions(FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E data){
			FLR_RESULT returncode = ClientPackager.BosonSetAutoGainSwitchConditions(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonGetAutoGainSwitchConditions(out FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E data){
			FLR_RESULT returncode = ClientPackager.BosonGetAutoGainSwitchConditions(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonSetGainSwitchParamsCATS(FLR_BOSON_GAIN_SWITCH_PARAMS_T parm_struct){
			FLR_RESULT returncode = ClientPackager.BosonSetGainSwitchParamsCATS(this, parm_struct);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonGetGainSwitchParamsCATS(out FLR_BOSON_GAIN_SWITCH_PARAMS_T parm_struct){
			FLR_RESULT returncode = ClientPackager.BosonGetGainSwitchParamsCATS(this, out parm_struct);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonGetGainSwitchRadiometricParamsCATS(out FLR_BOSON_GAIN_SWITCH_RADIOMETRIC_PARAMS_T parm_struct){
			FLR_RESULT returncode = ClientPackager.BosonGetGainSwitchRadiometricParamsCATS(this, out parm_struct);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonSetGainSwitchRadiometricParamsCATS(FLR_BOSON_GAIN_SWITCH_RADIOMETRIC_PARAMS_T parm_struct){
			FLR_RESULT returncode = ClientPackager.BosonSetGainSwitchRadiometricParamsCATS(this, parm_struct);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT bosonGetCLowToHighPercentCATS(out UInt32 cLowToHighPercent){
			FLR_RESULT returncode = ClientPackager.BosonGetCLowToHighPercentCATS(this, out cLowToHighPercent);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module dvo
		...
		public FLR_RESULT dvoSetMipiStartState(FLR_DVO_MIPI_STATE_E state){
			FLR_RESULT returncode = ClientPackager.DvoSetMipiStartState(this, state);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoGetMipiStartState(out FLR_DVO_MIPI_STATE_E state){
			FLR_RESULT returncode = ClientPackager.DvoGetMipiStartState(this, out state);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoSetMipiState(FLR_DVO_MIPI_STATE_E state){
			FLR_RESULT returncode = ClientPackager.DvoSetMipiState(this, state);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoGetMipiState(out FLR_DVO_MIPI_STATE_E state){
			FLR_RESULT returncode = ClientPackager.DvoGetMipiState(this, out state);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoSetMipiClockLaneMode(FLR_DVO_MIPI_CLOCK_LANE_MODE_E mode){
			FLR_RESULT returncode = ClientPackager.DvoSetMipiClockLaneMode(this, mode);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoGetMipiClockLaneMode(out FLR_DVO_MIPI_CLOCK_LANE_MODE_E mode){
			FLR_RESULT returncode = ClientPackager.DvoGetMipiClockLaneMode(this, out mode);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoSetOutputInterface(FLR_DVO_OUTPUT_INTERFACE_E format){
			FLR_RESULT returncode = ClientPackager.DvoSetOutputInterface(this, format);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoGetOutputInterface(out FLR_DVO_OUTPUT_INTERFACE_E format){
			FLR_RESULT returncode = ClientPackager.DvoGetOutputInterface(this, out format);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoSetOutputFormatVC1(FLR_DVO_OUTPUT_FORMAT_E format){
			FLR_RESULT returncode = ClientPackager.DvoSetOutputFormatVC1(this, format);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoGetOutputFormatVC1(out FLR_DVO_OUTPUT_FORMAT_E format){
			FLR_RESULT returncode = ClientPackager.DvoGetOutputFormatVC1(this, out format);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		// end Module dvo
	// Begin Module dvoMux
		public FLR_RESULT dvoMuxSetType(FLR_DVOMUX_OUTPUT_IF_E output, FLR_DVOMUX_SOURCE_E source, FLR_DVOMUX_TYPE_E type){
			FLR_RESULT returncode = ClientPackager.DvomuxSetType(this, output, source, type);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT dvoMuxGetType(FLR_DVOMUX_OUTPUT_IF_E output, out FLR_DVOMUX_SOURCE_E source, out FLR_DVOMUX_TYPE_E type){
			FLR_RESULT returncode = ClientPackager.DvomuxGetType(this, output, out source, out type);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module gao
		...
		public FLR_RESULT gaoSetFfcShutterSimulationState(FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoSetFfcShutterSimulationState(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetFfcShutterSimulationState(out FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoGetFfcShutterSimulationState(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoSetFfcShutterSimulatorValue(UInt16 value){
			FLR_RESULT returncode = ClientPackager.GaoSetFfcShutterSimulatorValue(this, value);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetFfcShutterSimulatorValue(out UInt16 value){
			FLR_RESULT returncode = ClientPackager.GaoGetFfcShutterSimulatorValue(this, out value);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoSetBcnrState(FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoSetBcnrState(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetBcnrState(out FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.GaoGetBcnrState(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetAppliedSffcScaleFactor(out Double data){
			FLR_RESULT returncode = ClientPackager.GaoGetAppliedSffcScaleFactor(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoSetSffcMode(FLR_GAO_SFFC_MODE_E mode){
			FLR_RESULT returncode = ClientPackager.GaoSetSffcMode(this, mode);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT gaoGetSffcMode(out FLR_GAO_SFFC_MODE_E mode){
			FLR_RESULT returncode = ClientPackager.GaoGetSffcMode(this, out mode);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module imageStats
		...
		public FLR_RESULT imageStatsGetPopAboveLowToHighThreshCATS(out UInt32 popAboveLowToHighThresh){
			FLR_RESULT returncode = ClientPackager.ImagestatsGetPopAboveLowToHighThreshCATS(this, out popAboveLowToHighThresh);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT imageStatsGetPopBelowHighToLowThreshCATS(out UInt32 popBelowHighToLowThresh){
			FLR_RESULT returncode = ClientPackager.ImagestatsGetPopBelowHighToLowThreshCATS(this, out popBelowHighToLowThresh);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT imageStatsGetPopBetweenLthCATSAndLthSATS(out UInt32 popBetweenCatsAndSats){
			FLR_RESULT returncode = ClientPackager.ImagestatsGetPopBetweenLthCATSAndLthSATS(this, out popBetweenCatsAndSats);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module latencyCtrl
		public FLR_RESULT latencyCtrlSetLowLatencyState(FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.LatencyctrlSetLowLatencyState(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlGetLowLatencyState(out FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.LatencyctrlGetLowLatencyState(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlSetJitterReduction(FLR_ENABLE_E enable, Int32 line){
			FLR_RESULT returncode = ClientPackager.LatencyctrlSetJitterReduction(this, enable, line);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlGetJitterReduction(out FLR_ENABLE_E enable, out Int32 line){
			FLR_RESULT returncode = ClientPackager.LatencyctrlGetJitterReduction(this, out enable, out line);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlLatencyResetStats(){
			FLR_RESULT returncode = ClientPackager.LatencyctrlLatencyResetStats(this);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlGetJitter(out Double jitterMin, out Double jitterMax){
			FLR_RESULT returncode = ClientPackager.LatencyctrlGetJitter(this, out jitterMin, out jitterMax);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlGetLatency(out Double latencyMin, out Double latencyMax){
			FLR_RESULT returncode = ClientPackager.LatencyctrlGetLatency(this, out latencyMin, out latencyMax);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlSetUsbVideoLatencyReduction(Int32 line){
			FLR_RESULT returncode = ClientPackager.LatencyctrlSetUsbVideoLatencyReduction(this, line);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT latencyCtrlGetUsbVideoLatencyReduction(out Int32 line){
			FLR_RESULT returncode = ClientPackager.LatencyctrlGetUsbVideoLatencyReduction(this, out line);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module spnr
		...
		public FLR_RESULT spnrSetSF(Double sf){
			FLR_RESULT returncode = ClientPackager.SpnrSetSF(this, sf);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrGetSF(out Double sf){
			FLR_RESULT returncode = ClientPackager.SpnrGetSF(this, out sf);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrSetDFFast(Double dffast){
			FLR_RESULT returncode = ClientPackager.SpnrSetDFFast(this, dffast);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrGetDFFast(out Double dffast){
			FLR_RESULT returncode = ClientPackager.SpnrGetDFFast(this, out dffast);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrSetDFSlow(Double dfslow){
			FLR_RESULT returncode = ClientPackager.SpnrSetDFSlow(this, dfslow);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrGetDFSlow(out Double dfslow){
			FLR_RESULT returncode = ClientPackager.SpnrGetDFSlow(this, out dfslow);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrSetSensitivityThreshold(Double threshold){
			FLR_RESULT returncode = ClientPackager.SpnrSetSensitivityThreshold(this, threshold);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrGetSensitivityThreshold(out Double threshold){
			FLR_RESULT returncode = ClientPackager.SpnrGetSensitivityThreshold(this, out threshold);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT spnrSetReset(FLR_SPNR_RESET_E resetType){
			FLR_RESULT returncode = ClientPackager.SpnrSetReset(this, resetType);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module symbology
		...
		public FLR_RESULT symbologyGetLocation(Byte ID, out Int16 pos_X, out Int16 pos_Y){
			FLR_RESULT returncode = ClientPackager.SymbologyGetLocation(this, ID, out pos_X, out pos_Y);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyGetSize(Byte ID, out Int16 width, out Int16 height){
			FLR_RESULT returncode = ClientPackager.SymbologyGetSize(this, ID, out width, out height);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyGetZorder(Byte ID, out Byte zorder){
			FLR_RESULT returncode = ClientPackager.SymbologyGetZorder(this, ID, out zorder);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyGetColor(Byte ID, out UInt32 color){
			FLR_RESULT returncode = ClientPackager.SymbologyGetColor(this, ID, out color);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyGetType(Byte ID, out FLR_SYMBOLOGY_TYPE_E type){
			FLR_RESULT returncode = ClientPackager.SymbologyGetType(this, ID, out type);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyCopySymbol(Byte source, Byte destination){
			FLR_RESULT returncode = ClientPackager.SymbologyCopySymbol(this, source, destination);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT symbologyGetTextFontSize(Byte ID, out Int16 size){
			FLR_RESULT returncode = ClientPackager.SymbologyGetTextFontSize(this, ID, out size);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module sysinfo
		...
		public FLR_RESULT sysinfoGetProbeTipType(out FLR_SYSINFO_PROBE_TIP_TYPE type){
			FLR_RESULT returncode = ClientPackager.SysinfoGetProbeTipType(this, out type);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module systemSymbols
		...
		public FLR_RESULT systemSymbolsGetSpotConfigIds(out FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T config){
			FLR_RESULT returncode = ClientPackager.SystemsymbolsGetSpotConfigIds(this, out config);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT systemSymbolsSetSpotConfigIds(FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T config){
			FLR_RESULT returncode = ClientPackager.SystemsymbolsSetSpotConfigIds(this, config);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT systemSymbolsGetIsoConfigIds(out FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T config){
			FLR_RESULT returncode = ClientPackager.SystemsymbolsGetIsoConfigIds(this, out config);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT systemSymbolsSetIsoConfigIds(FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T config){
			FLR_RESULT returncode = ClientPackager.SystemsymbolsSetIsoConfigIds(this, config);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module telemetry
		...
		public FLR_RESULT telemetrySetPackingVC1(FLR_TELEMETRY_PACKING_E data){
			FLR_RESULT returncode = ClientPackager.TelemetrySetPackingVC1(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT telemetryGetPackingVC1(out FLR_TELEMETRY_PACKING_E data){
			FLR_RESULT returncode = ClientPackager.TelemetryGetPackingVC1(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT telemetrySetMipiEmbeddedDataTag(FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.TelemetrySetMipiEmbeddedDataTag(this, data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT telemetryGetMipiEmbeddedDataTag(out FLR_ENABLE_E data){
			FLR_RESULT returncode = ClientPackager.TelemetryGetMipiEmbeddedDataTag(this, out data);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
	...
	// Begin Module testRamp
		...
		public FLR_RESULT testRampSetAnimationSettings(FLR_TESTRAMP_ANIMATION_SETTINGS_T settings){
			FLR_RESULT returncode = ClientPackager.TestrampSetAnimationSettings(this, settings);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
		...
		public FLR_RESULT testRampGetAnimationSettings(out FLR_TESTRAMP_ANIMATION_SETTINGS_T settings){
			FLR_RESULT returncode = ClientPackager.TestrampGetAnimationSettings(this, out settings);
			// Check for any errorcode
			if((UInt32) returncode != 0){
				return returncode;
			}
