...
namespace Boson {
	public partial class Camera{
		internal static class ClientPackager {
			...
			public static FLR_RESULT AgcSetDetailHeadroomBalance(Camera parent, Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_SETDETAILHEADROOMBALANCE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcGetDetailHeadroomBalance(Camera parent, out Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_GETDETAILHEADROOMBALANCE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcGetDetailHeadroomApplied(Camera parent, out Double countsHigh, out Double countsLow) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 8;
				...
				// Assign Null values to all receive parameters
				countsHigh = new Double();
				countsLow = new Double();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_GETDETAILHEADROOMAPPLIED, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				countsHigh = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
				...
				countsLow = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT AgcSetRadius(Camera parent, UInt32 data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_SETRADIUS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcGetRadius(Camera parent, out UInt32 data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_GETRADIUS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcSetGmax(Camera parent, Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_SETGMAX, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcGetGmax(Camera parent, out Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_GETGMAX, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcSetGmin(Camera parent, Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_SETGMIN, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT AgcGetGmin(Camera parent, out Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.AGC_GETGMIN, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonGetBoardID(Camera parent, out UInt32 data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_GETBOARDID, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonSetAutoGainSwitchConditions(Camera parent, FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_SETAUTOGAINSWITCHCONDITIONS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonGetAutoGainSwitchConditions(Camera parent, out FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				data = new FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_GETAUTOGAINSWITCHCONDITIONS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				data = (FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT BosonSetGainSwitchParamsCATS(Camera parent, FLR_BOSON_GAIN_SWITCH_PARAMS_T parm_struct) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 16;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_SETGAINSWITCHPARAMSCATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonGetGainSwitchParamsCATS(Camera parent, out FLR_BOSON_GAIN_SWITCH_PARAMS_T parm_struct) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 16;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_GETGAINSWITCHPARAMSCATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonGetGainSwitchRadiometricParamsCATS(Camera parent, out FLR_BOSON_GAIN_SWITCH_RADIOMETRIC_PARAMS_T parm_struct) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 16;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_GETGAINSWITCHRADIOMETRICPARAMSCATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonSetGainSwitchRadiometricParamsCATS(Camera parent, FLR_BOSON_GAIN_SWITCH_RADIOMETRIC_PARAMS_T parm_struct) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 16;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_SETGAINSWITCHRADIOMETRICPARAMSCATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT BosonGetCLowToHighPercentCATS(Camera parent, out UInt32 cLowToHighPercent) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.BOSON_GETCLOWTOHIGHPERCENTCATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoSetMipiStartState(Camera parent, FLR_DVO_MIPI_STATE_E state) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_SETMIPISTARTSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoGetMipiStartState(Camera parent, out FLR_DVO_MIPI_STATE_E state) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				state = new FLR_DVO_MIPI_STATE_E();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_GETMIPISTARTSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				state = (FLR_DVO_MIPI_STATE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT DvoSetMipiState(Camera parent, FLR_DVO_MIPI_STATE_E state) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_SETMIPISTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoGetMipiState(Camera parent, out FLR_DVO_MIPI_STATE_E state) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_GETMIPISTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoSetMipiClockLaneMode(Camera parent, FLR_DVO_MIPI_CLOCK_LANE_MODE_E mode) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_SETMIPICLOCKLANEMODE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoGetMipiClockLaneMode(Camera parent, out FLR_DVO_MIPI_CLOCK_LANE_MODE_E mode) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				mode = new FLR_DVO_MIPI_CLOCK_LANE_MODE_E();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_GETMIPICLOCKLANEMODE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				mode = (FLR_DVO_MIPI_CLOCK_LANE_MODE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT DvoSetOutputInterface(Camera parent, FLR_DVO_OUTPUT_INTERFACE_E format) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_SETOUTPUTINTERFACE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoGetOutputInterface(Camera parent, out FLR_DVO_OUTPUT_INTERFACE_E format) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				format = new FLR_DVO_OUTPUT_INTERFACE_E();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_GETOUTPUTINTERFACE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				format = (FLR_DVO_OUTPUT_INTERFACE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT DvoSetOutputFormatVC1(Camera parent, FLR_DVO_OUTPUT_FORMAT_E format) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_SETOUTPUTFORMATVC1, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvoGetOutputFormatVC1(Camera parent, out FLR_DVO_OUTPUT_FORMAT_E format) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVO_GETOUTPUTFORMATVC1, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			// Begin Module: dvoMux
			public static FLR_RESULT DvomuxSetType(Camera parent, FLR_DVOMUX_OUTPUT_IF_E output, FLR_DVOMUX_SOURCE_E source, FLR_DVOMUX_TYPE_E type) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 12;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				INT_32ToByte((Int32) output,sendData,outPtr);
				outPtr += 4;
				...
				INT_32ToByte((Int32) source,sendData,outPtr);
				outPtr += 4;
				...
				INT_32ToByte((Int32) type,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVOMUX_SETTYPE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT DvomuxGetType(Camera parent, FLR_DVOMUX_OUTPUT_IF_E output, out FLR_DVOMUX_SOURCE_E source, out FLR_DVOMUX_TYPE_E type) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 8;
				...
				// Assign Null values to all receive parameters
				source = new FLR_DVOMUX_SOURCE_E();
				type = new FLR_DVOMUX_TYPE_E();
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.DVOMUX_GETTYPE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				source = (FLR_DVOMUX_SOURCE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
				...
				type = (FLR_DVOMUX_TYPE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT GaoSetFfcShutterSimulationState(Camera parent, FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_SETFFCSHUTTERSIMULATIONSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoGetFfcShutterSimulationState(Camera parent, out FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_GETFFCSHUTTERSIMULATIONSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoSetFfcShutterSimulatorValue(Camera parent, UInt16 value) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 2;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				UINT_16ToByte(value,sendData,outPtr);
				outPtr += 2;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_SETFFCSHUTTERSIMULATORVALUE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoGetFfcShutterSimulatorValue(Camera parent, out UInt16 value) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 2;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_GETFFCSHUTTERSIMULATORVALUE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				value = byteToUINT_16(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT GaoSetBcnrState(Camera parent, FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_SETBCNRSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoGetBcnrState(Camera parent, out FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_GETBCNRSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoGetAppliedSffcScaleFactor(Camera parent, out Double data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_GETAPPLIEDSFFCSCALEFACTOR, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoSetSffcMode(Camera parent, FLR_GAO_SFFC_MODE_E mode) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_SETSFFCMODE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT GaoGetSffcMode(Camera parent, out FLR_GAO_SFFC_MODE_E mode) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				mode = new FLR_GAO_SFFC_MODE_E();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.GAO_GETSFFCMODE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				mode = (FLR_GAO_SFFC_MODE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT ImagestatsGetPopAboveLowToHighThreshCATS(Camera parent, out UInt32 popAboveLowToHighThresh) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				popAboveLowToHighThresh = new UInt32();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.IMAGESTATS_GETPOPABOVELOWTOHIGHTHRESHCATS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				popAboveLowToHighThresh = byteToUINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT ImagestatsGetPopBelowHighToLowThreshCATS(Camera parent, out UInt32 popBelowHighToLowThresh) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				popBelowHighToLowThresh = new UInt32();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.IMAGESTATS_GETPOPBELOWHIGHTOLOWTHRESHCATS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				popBelowHighToLowThresh = byteToUINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT ImagestatsGetPopBetweenLthCATSAndLthSATS(Camera parent, out UInt32 popBetweenCatsAndSats) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				popBetweenCatsAndSats = new UInt32();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.IMAGESTATS_GETPOPBETWEENLTHCATSANDLTHSATS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				popBetweenCatsAndSats = byteToUINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT LatencyctrlSetLowLatencyState(Camera parent, FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_SETLOWLATENCYSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT LatencyctrlGetLowLatencyState(Camera parent, out FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_GETLOWLATENCYSTATE, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT LatencyctrlSetJitterReduction(Camera parent, FLR_ENABLE_E enable, Int32 line) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 8;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				INT_32ToByte((Int32) enable,sendData,outPtr);
				outPtr += 4;
				...
				INT_32ToByte(line,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_SETJITTERREDUCTION, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT LatencyctrlGetJitterReduction(Camera parent, out FLR_ENABLE_E enable, out Int32 line) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 8;
				...
				// Assign Null values to all receive parameters
				enable = new FLR_ENABLE_E();
				line = new Int32();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_GETJITTERREDUCTION, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				enable = (FLR_ENABLE_E) byteToINT_32(receiveData,inPtr);
				inPtr+=4;
				...
				line = byteToINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT LatencyctrlLatencyResetStats(Camera parent) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_LATENCYRESETSTATS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT LatencyctrlGetJitter(Camera parent, out Double jitterMin, out Double jitterMax) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 8;
				...
				// Assign Null values to all receive parameters
				jitterMin = new Double();
				jitterMax = new Double();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_GETJITTER, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				jitterMin = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
				...
				jitterMax = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT LatencyctrlGetLatency(Camera parent, out Double latencyMin, out Double latencyMax) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 8;
				...
				// Assign Null values to all receive parameters
				latencyMin = new Double();
				latencyMax = new Double();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_GETLATENCY, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				latencyMin = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
				...
				latencyMax = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT LatencyctrlSetUsbVideoLatencyReduction(Camera parent, Int32 line) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_SETUSBVIDEOLATENCYREDUCTION, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT LatencyctrlGetUsbVideoLatencyReduction(Camera parent, out Int32 line) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.LATENCYCTRL_GETUSBVIDEOLATENCYREDUCTION, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrSetSF(Camera parent, Double sf) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLOATToByte(sf,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_SETSF, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrGetSF(Camera parent, out Double sf) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_GETSF, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrSetDFFast(Camera parent, Double dffast) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLOATToByte(dffast,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_SETDFFAST, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrGetDFFast(Camera parent, out Double dffast) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_GETDFFAST, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				dffast = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT SpnrSetDFSlow(Camera parent, Double dfslow) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLOATToByte(dfslow,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_SETDFSLOW, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrGetDFSlow(Camera parent, out Double dfslow) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_GETDFSLOW, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				dfslow = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT SpnrSetSensitivityThreshold(Camera parent, Double threshold) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLOATToByte(threshold,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_SETSENSITIVITYTHRESHOLD, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SpnrGetSensitivityThreshold(Camera parent, out Double threshold) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_GETSENSITIVITYTHRESHOLD, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				threshold = byteToFLOAT(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT SpnrSetReset(Camera parent, FLR_SPNR_RESET_E resetType) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				INT_32ToByte((Int32) resetType,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SPNR_SETRESET, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SymbologyGetLocation(Camera parent, Byte ID, out Int16 pos_X, out Int16 pos_Y) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETLOCATION, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				pos_X = byteToINT_16(receiveData,inPtr);
				inPtr+=2;
				...
				pos_Y = byteToINT_16(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT SymbologyGetSize(Camera parent, Byte ID, out Int16 width, out Int16 height) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETSIZE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				width = byteToINT_16(receiveData,inPtr);
				inPtr+=2;
				...
				height = byteToINT_16(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT SymbologyGetZorder(Camera parent, Byte ID, out Byte zorder) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 1;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETZORDER, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				zorder = byteToUCHAR(receiveData,inPtr);
				inPtr+=1;
			...
			public static FLR_RESULT SymbologyGetColor(Camera parent, Byte ID, out UInt32 color) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETCOLOR, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				color = byteToUINT_32(receiveData,inPtr);
				inPtr+=4;
			...
			public static FLR_RESULT SymbologyGetType(Camera parent, Byte ID, out FLR_SYMBOLOGY_TYPE_E type) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 2;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETTYPE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				type = (FLR_SYMBOLOGY_TYPE_E) byteToINT_16(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT SymbologyCopySymbol(Camera parent, Byte source, Byte destination) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 2;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				UCHARToByte(source,sendData,outPtr);
				outPtr += 1;
				...
				UCHARToByte(destination,sendData,outPtr);
				outPtr += 1;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_COPYSYMBOL, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SymbologyGetTextFontSize(Camera parent, Byte ID, out Int16 size) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 1;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 2;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYMBOLOGY_GETTEXTFONTSIZE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				size = byteToINT_16(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT SysinfoGetProbeTipType(Camera parent, out FLR_SYSINFO_PROBE_TIP_TYPE type) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				...
				// Assign Null values to all receive parameters
				type = new FLR_SYSINFO_PROBE_TIP_TYPE();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYSINFO_GETPROBETIPTYPE, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				type = byteToFLR_SYSINFO_PROBE_TIP_TYPE(receiveData,inPtr);
				inPtr+=5;
			...
			public static FLR_RESULT SystemsymbolsGetSpotConfigIds(Camera parent, out FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T config) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 13;
				Byte[] receiveData = new Byte[receiveBytes];
				UInt16 outPtr = 0;
				
				// Assign Null values to all receive parameters
				config = new FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYSTEMSYMBOLS_GETSPOTCONFIGIDS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				config = byteToFLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T(receiveData,inPtr);
				inPtr+=13;
			...
			public static FLR_RESULT SystemsymbolsSetSpotConfigIds(Camera parent, FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T config) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 13;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_TToByte(config,sendData,outPtr);
				outPtr += 13;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYSTEMSYMBOLS_SETSPOTCONFIGIDS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT SystemsymbolsGetIsoConfigIds(Camera parent, out FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T config) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 2;
				...
				// Assign Null values to all receive parameters
				config = new FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYSTEMSYMBOLS_GETISOCONFIGIDS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				config = byteToFLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T(receiveData,inPtr);
				inPtr+=2;
			...
			public static FLR_RESULT SystemsymbolsSetIsoConfigIds(Camera parent, FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T config) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 2;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_TToByte(config,sendData,outPtr);
				outPtr += 2;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.SYSTEMSYMBOLS_SETISOCONFIGIDS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TelemetrySetPackingVC1(Camera parent, FLR_TELEMETRY_PACKING_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TELEMETRY_SETPACKINGVC1, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TelemetryGetPackingVC1(Camera parent, out FLR_TELEMETRY_PACKING_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TELEMETRY_GETPACKINGVC1, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TelemetrySetMipiEmbeddedDataTag(Camera parent, FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TELEMETRY_SETMIPIEMBEDDEDDATATAG, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TelemetryGetMipiEmbeddedDataTag(Camera parent, out FLR_ENABLE_E data) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TELEMETRY_GETMIPIEMBEDDEDDATATAG, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TestrampSetAnimationSettings(Camera parent, FLR_TESTRAMP_ANIMATION_SETTINGS_T settings) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 4;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 0;
				...
				FLR_TESTRAMP_ANIMATION_SETTINGS_TToByte(settings,sendData,outPtr);
				outPtr += 4;
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TESTRAMP_SETANIMATIONSETTINGS, sendData, sendBytes, receiveData, ref receiveBytes);
			...
			public static FLR_RESULT TestrampGetAnimationSettings(Camera parent, out FLR_TESTRAMP_ANIMATION_SETTINGS_T settings) {
				// Allocate buffers with space for marshalled data
				UInt32 sendBytes = 0;
				Byte[] sendData = new Byte[sendBytes];
				UInt32 receiveBytes = 4;
				...
				// Assign Null values to all receive parameters
				settings = new FLR_TESTRAMP_ANIMATION_SETTINGS_T();
				
				FLR_RESULT returncode = parent.dispatcher(commandCount++, FLR_FUNCTION.TESTRAMP_GETANIMATIONSETTINGS, sendData, sendBytes, receiveData, ref receiveBytes);
				...
				settings = byteToFLR_TESTRAMP_ANIMATION_SETTINGS_T(receiveData,inPtr);
				inPtr+=4;
