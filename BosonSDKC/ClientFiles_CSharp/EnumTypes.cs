...
namespace Boson {
	public partial class Camera {
		...
		public enum FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_E : int {
			FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_RELATIVE_HOT = 0,
			FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_RELATIVE_COLD = 1,
			FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_RELATIVE_HOT_OR_COLD = 2,
			FLR_BOSON_AUTOGAIN_SWITCH_CONDITION_END = 3,
		}
		...
		public enum FLR_COLORLUT_ID_E : int {
			...
			FLR_COLORLUT_10 = 10,
			FLR_COLORLUT_EMBERGLOW = 10,
			FLR_COLORLUT_11 = 11,
			FLR_COLORLUT_AURORA = 11,
			FLR_COLORLUT_ID_END = 12,
		}
		...
		public enum FLR_DVO_OUTPUT_RGB_FORMAT_E : int {
			...
			FLR_DVO_RGB565 = 2,
			FLR_DVO_MRGB565 = 3,
			FLR_DVO_OUTPUT_RGB_FORMAT_END = 4,
		}
		...
		public enum FLR_DVO_OUTPUT_INTERFACE_E : int {
			FLR_DVO_CMOS = 0,
			FLR_DVO_MIPI = 1,
		...
		public enum FLR_DVO_MIPI_STATE_E : int {
		...
		public enum FLR_DVO_MIPI_CLOCK_LANE_MODE_E : int {
			FLR_DVO_MIPI_CLOCK_LANE_MODE_NON_CONTINUOUS = 0,
			FLR_DVO_MIPI_CLOCK_LANE_MODE_CONTINUOUS = 1,
			FLR_DVO_MIPI_CLOCK_LANE_MODE_END = 2,
		}
		
		public enum FLR_DVOMUX_TYPE_E : int {
			FLR_DVOMUX_TYPE_MONO16 = 0,
			FLR_DVOMUX_TYPE_MONO8 = 1,
			FLR_DVOMUX_TYPE_COLOR = 2,
			FLR_DVOMUX_TYPE_ANALOG = 3,
			FLR_DVOMUX_TYPE_MONO14 = 4,
			FLR_DVOMUX_TYPE_END = 5,
		}
		
		public enum FLR_DVOMUX_SOURCE_E : int {
			FLR_DVOMUX_SRC_IR = 0,
			FLR_DVOMUX_SRC_VIS = 1,
			FLR_DVOMUX_SRC_H264DEC = 2,
			FLR_DVOMUX_SRC_END = 3,
		}
		
		public enum FLR_DVOMUX_OUTPUT_IF_E : int {
			FLR_DVOMUX_OUTPUT_IF_DVO = 0,
			FLR_DVOMUX_OUTPUT_IF_UVC = 1,
			FLR_DVOMUX_OUTPUT_IF_CAPTURE = 2,
			FLR_DVOMUX_OUTPUT_IF_MIPITX = 3,
			FLR_DVOMUX_OUTPUT_IF_H264ENC = 4,
			FLR_DVOMUX_OUTPUT_IF_END = 5,
		}
		...
		public enum FLR_GAO_SFFC_MODE_E : int {
			FLR_GAO_SFFC_MODE_TRADITIONAL = 0,
			FLR_GAO_SFFC_MODE_BOSS = 1,
			FLR_GAO_SFFC_MODE_END = 3,
		}
		...
		public enum FLR_SPNR_RESET_E : int {
			FLR_SPNR_HARD_RESET = 0,
			FLR_SPNR_SOFT_RESET = 1,
		}
		...
		public enum FLR_SYMBOLOGY_TYPE_E : short {
			FLR_SYMBOLOGY_EMPTY = 0,
			FLR_SYMBOLOGY_BITMAP = 1,
			FLR_SYMBOLOGY_ARC = 2,
			FLR_SYMBOLOGY_TEXT = 3,
			FLR_SYMBOLOGY_FILLEDRECTANGLE = 4,
			FLR_SYMBOLOGY_RECTANGLE = 5,
			FLR_SYMBOLOGY_FILLEDELLIPSE = 6,
			FLR_SYMBOLOGY_LINE = 7,
			FLR_SYMBOLOGY_SPRITE = 8,
		}
		...
		public enum FLR_SYSINFO_SW_CONFIG_ID_E : int {
			...
			FLR_SYSINFO_BOSON_1904 = 15,
			FLR_SYSINFO_BOSON_OUTLINE_1406 = 16,
			FLR_SYSINFO_GRAVITON_1406 = 17,
			FLR_SYSINFO_BOSON_OUTLINE_1407 = 18,
			FLR_SYSINFO_SENSORTEST_1904 = 19,
			FLR_SYSINFO_BOSON_MIPI_1407 = 20,
			FLR_SYSINFO_BOSON_MIPI_1406 = 21,
			FLR_SYSINFO_BOSON_BASE_1407 = 22,
			FLR_SYSINFO_BOSON_BASE_1406 = 23,
			FLR_SYSINFO_BOSON_MIPI_1904 = 24,
		}
		...
		public enum FLR_SYSINFO_PROBE_TIP_MODEL_E : int {
			FLR_SYSINFO_PTM_UNKNOWN = 0,
			FLR_SYSINFO_PTM_VSC_IR32 = 1,
			FLR_SYSINFO_PTM_VSC_IR21 = 2,
			FLR_SYSINFO_PTM_VS80CIR_21 = 3,
			FLR_SYSINFO_PTM_VSC_IR33 = 4,
			FLR_SYSINFO_PTM_LAST = 5,
		}
		...
		public enum FLR_TESTRAMP_TYPE_E : int {
			...
			FLR_TESTRAMP_DMA_LAST = 18,
			FLR_TESTRAMP_ONSHAVE_START = 30,
			FLR_TESTRAMP_ONSHAVE_VERT_SHADE = 30,
			FLR_TESTRAMP_ONSHAVE_HORIZ_SHADE = 31,
			FLR_TESTRAMP_ONSHAVE_DIAG_SHADE = 32,
			FLR_TESTRAMP_ONSHAVE_ANIMATION = 33,
			FLR_TESTRAMP_TYPE_LAST = 34,
		}
