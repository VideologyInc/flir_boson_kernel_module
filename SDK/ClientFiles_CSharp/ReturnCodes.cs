...
namespace Boson {
	public partial class Camera {
		public enum FLR_RESULT : int {
			...
			FLR_FLASH_ERASE_ERROR                    = 1701, // 0x000006A5
			FLR_FLASH_WRITE_ERROR                    = 1702, // 0x000006A6
			FLR_FLASH_READ_ERROR                     = 1703, // 0x000006A7
			FLR_FLASH_BUSY_ERROR                     = 1704, // 0x000006A8
			FLR_FLASH_ADDRESS_ERROR                  = 1705, // 0x000006A9
			FLR_FLASH_RANGE_ERROR                    = 1706, // 0x000006AA
			FLR_FLASH_ACCESS_ERROR                   = 1707, // 0x000006AB
			FLR_FLASH_OPERATION_RETRY_ERROR          = 1708, // 0x000006AC
			FLR_FLASH_UNKNOWN_ERROR                  = 1709, // 0x000006AD
			...
			FLR_UNKNOWN_PROBE_MODEL                  = 1900, // 0x0000076C
		}
