...
namespace Boson {
	public partial class Camera {
		...
		[ StructLayout( LayoutKind.Sequential )]
		public struct FLR_SYSINFO_PROBE_TIP_TYPE {
			public FLR_SYSINFO_PROBE_TIP_MODEL_E model;
			public Byte hwRevision;
			public static bool operator ==(FLR_SYSINFO_PROBE_TIP_TYPE self, FLR_SYSINFO_PROBE_TIP_TYPE other) {
				return ((self.model == other.model) && (self.hwRevision == other.hwRevision));
			}
			public static bool operator !=(FLR_SYSINFO_PROBE_TIP_TYPE self, FLR_SYSINFO_PROBE_TIP_TYPE other) {
				return !(self == other);
			}
		...
		private static FLR_SYSINFO_PROBE_TIP_TYPE byteToFLR_SYSINFO_PROBE_TIP_TYPE( Byte[] inBuff, UInt16 inPtr) {
			
			UInt16 ptr = inPtr;
			FLR_SYSINFO_PROBE_TIP_TYPE outVal;
			outVal.model =(FLR_SYSINFO_PROBE_TIP_MODEL_E) byteToINT_32(inBuff,ptr);
			ptr += 4;
			
			outVal.hwRevision = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			return outVal;
		} //end byteToFLR_SYSINFO_PROBE_TIP_TYPE()
		private static void FLR_SYSINFO_PROBE_TIP_TYPEToByte(FLR_SYSINFO_PROBE_TIP_TYPE inVal, Byte[] outBuff, UInt16 outPtr) {
			
			UInt16 ptr = outPtr;
			INT_32ToByte((Int32)(inVal.model),outBuff,ptr);
			ptr += 4;
			
			UCHARToByte((inVal.hwRevision),outBuff,ptr);
			ptr += 1;
		...
		public struct FLR_SYSTEMSYMBOLS_SPOTCONFIG_T {
			...
			public FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T greenBarOutline;
			...
			public static bool operator ==(FLR_SYSTEMSYMBOLS_SPOTCONFIG_T self, FLR_SYSTEMSYMBOLS_SPOTCONFIG_T other) {
				return ((self.symbol == other.symbol) && (self.area == other.area) && (self.min == other.min) && (self.max == other.max) && (self.mean == other.mean) && (self.meanBar == other.meanBar) && (self.greenBarOutline == other.greenBarOutline) && (self.greenBar == other.greenBar) && (self.greenBarText1 == other.greenBarText1) && (self.greenBarText2 == other.greenBarText2) && (self.greenBarText3 == other.greenBarText3) && (self.greenBarText4 == other.greenBarText4) && (self.greenBarText5 == other.greenBarText5));
			}
			public static bool operator !=(FLR_SYSTEMSYMBOLS_SPOTCONFIG_T self, FLR_SYSTEMSYMBOLS_SPOTCONFIG_T other) {
				return !(self == other);
			}
		...
		private static FLR_SYSTEMSYMBOLS_SPOTCONFIG_T byteToFLR_SYSTEMSYMBOLS_SPOTCONFIG_T( Byte[] inBuff, UInt16 inPtr) {
			...
			outVal.greenBarOutline = byteToFLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T(inBuff,ptr);
			ptr += 15;
		...
		private static void FLR_SYSTEMSYMBOLS_SPOTCONFIG_TToByte(FLR_SYSTEMSYMBOLS_SPOTCONFIG_T inVal, Byte[] outBuff, UInt16 outPtr) {
			...
			FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_TToByte((inVal.greenBarOutline),outBuff,ptr);
			ptr += 15;
		...
		[ StructLayout( LayoutKind.Sequential )]
		public struct FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T {
			public Byte symbol;
			public Byte area;
			public Byte min;
			public Byte max;
			public Byte mean;
			public Byte meanBar;
			public Byte greenBarOutline;
			public Byte greenBar;
			public Byte greenBarText1;
			public Byte greenBarText2;
			public Byte greenBarText3;
			public Byte greenBarText4;
			public Byte greenBarText5;
			public static bool operator ==(FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T self, FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T other) {
				return ((self.symbol == other.symbol) && (self.area == other.area) && (self.min == other.min) && (self.max == other.max) && (self.mean == other.mean) && (self.meanBar == other.meanBar) && (self.greenBarOutline == other.greenBarOutline) && (self.greenBar == other.greenBar) && (self.greenBarText1 == other.greenBarText1) && (self.greenBarText2 == other.greenBarText2) && (self.greenBarText3 == other.greenBarText3) && (self.greenBarText4 == other.greenBarText4) && (self.greenBarText5 == other.greenBarText5));
			}
			public static bool operator !=(FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T self, FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T other) {
				return !(self == other);
		...
		private static FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T byteToFLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T( Byte[] inBuff, UInt16 inPtr) {
			
			UInt16 ptr = inPtr;
			FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T outVal;
			outVal.symbol = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.area = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.min = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.max = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.mean = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.meanBar = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarOutline = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBar = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarText1 = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarText2 = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarText3 = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarText4 = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.greenBarText5 = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			return outVal;
		} //end byteToFLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T()
		private static void FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_TToByte(FLR_SYSTEMSYMBOLS_SPOTCONFIG_ID_T inVal, Byte[] outBuff, UInt16 outPtr) {
			
			UInt16 ptr = outPtr;
			UCHARToByte((inVal.symbol),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.area),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.min),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.max),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.mean),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.meanBar),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarOutline),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBar),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarText1),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarText2),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarText3),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarText4),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.greenBarText5),outBuff,ptr);
			ptr += 1;
		...
		public struct FLR_SYSTEMSYMBOLS_ISOCONFIG_T {
			public FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T colorBar;
			...
			public static bool operator ==(FLR_SYSTEMSYMBOLS_ISOCONFIG_T self, FLR_SYSTEMSYMBOLS_ISOCONFIG_T other) {
				return ((self.colorBar == other.colorBar) && (self.colorBarOutline == other.colorBarOutline));
			}
			public static bool operator !=(FLR_SYSTEMSYMBOLS_ISOCONFIG_T self, FLR_SYSTEMSYMBOLS_ISOCONFIG_T other) {
				return !(self == other);
			}
		...
		private static FLR_SYSTEMSYMBOLS_ISOCONFIG_T byteToFLR_SYSTEMSYMBOLS_ISOCONFIG_T( Byte[] inBuff, UInt16 inPtr) {
			...
			outVal.colorBar = byteToFLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_T(inBuff,ptr);
			ptr += 15;
		...
		private static void FLR_SYSTEMSYMBOLS_ISOCONFIG_TToByte(FLR_SYSTEMSYMBOLS_ISOCONFIG_T inVal, Byte[] outBuff, UInt16 outPtr) {
			...
			UInt16 ptr = outPtr;
			FLR_SYSTEMSYMBOLS_SPOT_ISO_ENTRY_TToByte((inVal.colorBar),outBuff,ptr);
			ptr += 15;
		...
		[ StructLayout( LayoutKind.Sequential )]
		public struct FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T {
			public Byte colorBar;
			public Byte colorBarOutline;
			public static bool operator ==(FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T self, FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T other) {
				return ((self.colorBar == other.colorBar) && (self.colorBarOutline == other.colorBarOutline));
			}
			public static bool operator !=(FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T self, FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T other) {
				return !(self == other);
		...
		private static FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T byteToFLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T( Byte[] inBuff, UInt16 inPtr) {
			
			UInt16 ptr = inPtr;
			FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T outVal;
			outVal.colorBar = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			outVal.colorBarOutline = byteToUCHAR(inBuff,ptr);
			ptr += 1;
			
			return outVal;
		} //end byteToFLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T()
		private static void FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_TToByte(FLR_SYSTEMSYMBOLS_ISOCONFIG_ID_T inVal, Byte[] outBuff, UInt16 outPtr) {
			
			UInt16 ptr = outPtr;
			UCHARToByte((inVal.colorBar),outBuff,ptr);
			ptr += 1;
			
			UCHARToByte((inVal.colorBarOutline),outBuff,ptr);
			ptr += 1;
		...
		[ StructLayout( LayoutKind.Sequential )]
		public struct FLR_TESTRAMP_ANIMATION_SETTINGS_T {
			public Int16 moveLines;
			public UInt16 moveFrames;
			public static bool operator ==(FLR_TESTRAMP_ANIMATION_SETTINGS_T self, FLR_TESTRAMP_ANIMATION_SETTINGS_T other) {
				return ((self.moveLines == other.moveLines) && (self.moveFrames == other.moveFrames));
			}
			public static bool operator !=(FLR_TESTRAMP_ANIMATION_SETTINGS_T self, FLR_TESTRAMP_ANIMATION_SETTINGS_T other) {
				return !(self == other);
			}
		...
		private static FLR_TESTRAMP_ANIMATION_SETTINGS_T byteToFLR_TESTRAMP_ANIMATION_SETTINGS_T( Byte[] inBuff, UInt16 inPtr) {
			
			UInt16 ptr = inPtr;
			FLR_TESTRAMP_ANIMATION_SETTINGS_T outVal;
			outVal.moveLines = byteToINT_16(inBuff,ptr);
			ptr += 2;
			
			outVal.moveFrames = byteToUINT_16(inBuff,ptr);
			ptr += 2;
			
			return outVal;
		} //end byteToFLR_TESTRAMP_ANIMATION_SETTINGS_T()
		private static void FLR_TESTRAMP_ANIMATION_SETTINGS_TToByte(FLR_TESTRAMP_ANIMATION_SETTINGS_T inVal, Byte[] outBuff, UInt16 outPtr) {
			
			UInt16 ptr = outPtr;
			INT_16ToByte((inVal.moveLines),outBuff,ptr);
			ptr += 2;
			
			UINT_16ToByte((inVal.moveFrames),outBuff,ptr);
			ptr += 2;
