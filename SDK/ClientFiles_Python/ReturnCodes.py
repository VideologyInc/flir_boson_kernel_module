...
#   0x0300 -> 0x03FF is allocated to symbology/graphics specific codes (Jeff, Mobica)
    ...
    FLR_FLASH_XX_ERROR                       = 1700 #/*!< Generic Flash Error Section */
    FLR_FLASH_ERASE_ERROR                    = 1701 #/*!< Flash Erase Error */
    FLR_FLASH_WRITE_ERROR                    = 1702 #/*!< Flash Write Error */
    FLR_FLASH_READ_ERROR                     = 1703 #/*!< Flash Read Error */
    FLR_FLASH_BUSY_ERROR                     = 1704 #/*!< A flash operation was tried but the flash was busy */
    FLR_FLASH_ADDRESS_ERROR                  = 1705 #/*!< An improper flash address was used */
    FLR_FLASH_RANGE_ERROR                    = 1706 #/*!< A flash operation caused the access to be out of the range of the device */
    FLR_FLASH_ACCESS_ERROR                   = 1707 #/*!< A mal-formed flash operation would cause an invalid access */
    FLR_FLASH_OPERATION_RETRY_ERROR          = 1708 #/*!< A flash operation exceeded the flash retry limits */
    FLR_FLASH_UNKNOWN_ERROR                  = 1709 #/*!< An undefined error was returned from a valid operation */
    ...
    #/// Probe tip SN section
    FLR_UNKNOWN_PROBE_MODEL             = 1900 #/*!< Unknown probe serial number */
