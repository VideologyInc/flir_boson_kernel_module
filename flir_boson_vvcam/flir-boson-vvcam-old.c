...
static const struct of_device_id flir_boson_of_match[] = {{.compatible = "flir,boson-vvcam"}, {/* sentinel */}};
MODULE_DEVICE_TABLE(of, flir_boson_of_match);

static const struct i2c_device_id flir_boson_i2c_id[] = {{"flir-boson-vvcam", 0}, {}};
MODULE_DEVICE_TABLE(i2c, flir_boson_i2c_id);

static struct i2c_driver flir_boson_driver = {
    .driver =
        {
            .name           = "flir-boson-vvcam",
